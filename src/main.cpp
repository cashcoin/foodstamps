...
uint256 hashGenesisBlock("0x48f62e5a4448964d8102f8f6b00cca371cfe20c884f8a3da03cd8fc1d561e3d7");
...
const string strMessageMagic = "Foodstamps Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 1440) // first day block reward
        nSubsidy = 1000;
    if(nHeight > 259200) // block reward drops by 20% in approximately 6 months
        nSubsidy = 40;
    if(nHeight > 388800) // block reward drops by 30% in approximately 9 months
        nSubsidy = 35;
    if(nHeight > 525600) // block reward drops by 50% in approximately 1 year
        nSubsidy = 25;
...
static const int64 nTargetTimespan = 0.25 * 24 * 60 * 60; // Foodstamps: 0.25 days
static const int64 nTargetSpacing = 60; // Foodstamps: 60 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal foodstamps miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Foodstamps", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xecec27b907d6d218c02cac62229bf79ee51969dcb0e9a91860bea012af6faca8");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Launch of Foodstamps";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391212090;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 387179385;

        if (fTestNet)
        {
            block.nTime    = 1390760304;
        ...
        assert(block.hashMerkleRoot == uint256("0x29bbbad7d81a8fc6d9e4dbde8dcd4936770b85a41652645e5b06a7e9cb3a223d"));
